...
async def get_node_options_controller(
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_task:cronjob:node:query"]))],
) -> JSONResponse:
    """
...
async def get_obj_detail_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_task:cronjob:node:detail"]))],
) -> JSONResponse:
    """
    获取节点详情
...
async def create_obj_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_task:cronjob:node:create"]))],
) -> JSONResponse:
    """
    创建节点
...
async def update_obj_controller(
    ...
    id: Annotated[int, Path(description="节点ID")],
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_task:cronjob:node:update"]))],
) -> JSONResponse:
    """
    修改节点
...
async def delete_obj_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_task:cronjob:node:delete"]))],
) -> JSONResponse:
    """
    删除节点
...
async def execute_job_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_task:cronjob:node:execute"]))],
) -> JSONResponse:
    """
    调试节点

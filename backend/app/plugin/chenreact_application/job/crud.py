...
from .model import AppJobLogModel, AppJobModel
from .schema import (
    JobCreateSchema,
    JobLogCreateSchema,
    JobLogUpdateSchema,
...
class JobCRUD(CRUDBase[AppJobModel, JobCreateSchema, JobUpdateSchema]):
    """定时任务数据层"""
    ...
    def __init__(self, auth: AuthSchema) -> None:
        ...
        """
        self.auth = auth
        super().__init__(model=AppJobModel, auth=auth)
    ...
    async def get_obj_by_id_crud(
        ...
        返回:
        - AppJobModel | None: 定时任务模型,如果不存在则为None
        """
    ...
    async def get_obj_list_crud(
        ...
        返回:
        - Sequence[AppJobModel]: 定时任务模型序列
        """
        return await self.list(search=search, order_by=order_by, preload=preload)

    async def create_obj_crud(self, data: JobCreateSchema) -> AppJobModel | None:
        """
        创建定时任务
        ...
        返回:
        - AppJobModel | None: 创建的定时任务模型,如果创建失败则为None
        """
        return await self.create(data=data)

    async def update_obj_crud(self, id: int, data: JobUpdateSchema) -> AppJobModel | None:
        """
        更新定时任务
        ...
        返回:
        - AppJobModel | None: 更新后的定时任务模型,如果更新失败则为None
        """
...
class JobLogCRUD(CRUDBase[AppJobLogModel, JobLogCreateSchema, JobLogUpdateSchema]):
    """定时任务日志数据层"""
    ...
    def __init__(self, auth: AuthSchema) -> None:
        ...
        """
        self.auth = auth
        super().__init__(model=AppJobLogModel, auth=auth)
    ...
    async def get_obj_log_by_id_crud(
        ...
        返回:
        - AppJobLogModel | None: 定时任务日志模型,如果不存在则为None
        """
        return await self.get(id=id, preload=preload)
    ...
    async def get_obj_log_list_crud(
        ...
        返回:
        - Sequence[AppJobLogModel]: 定时任务日志模型序列
        """
        return await self.list(search=search, order_by=order_by, preload=preload)

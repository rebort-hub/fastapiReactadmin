...
async def get_obj_detail_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_application:job:detail"]))],
) -> JSONResponse:
    """
    获取定时任务详情
...
async def get_obj_list_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_application:job:query"]))],
) -> JSONResponse:
    """
    查询定时任务
...
async def create_obj_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_application:job:create"]))],
) -> JSONResponse:
    """
    创建定时任务
...
async def update_obj_controller(
    ...
    id: Annotated[int, Path(description="定时任务ID")],
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_application:job:update"]))],
) -> JSONResponse:
    """
    修改定时任务
...
async def delete_obj_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_application:job:delete"]))],
) -> JSONResponse:
    """
    删除定时任务
...
async def export_obj_list_controller(
    search: Annotated[JobQueryParam, Depends()],
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_application:job:export"]))],
) -> StreamingResponse:
    """
    导出定时任务
...
@JobRouter.get(
    ...
    dependencies=[Depends(AuthPermission(["chenreact_application:job:query"]))],
)

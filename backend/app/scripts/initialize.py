...
from app.api.v1.chenreact_system.dept.model import DeptModel
from app.api.v1.chenreact_system.dict.model import DictDataModel, DictTypeModel
from app.api.v1.chenreact_system.menu.model import MenuModel
from app.api.v1.chenreact_system.params.model import ParamsModel
from app.api.v1.chenreact_system.position.model import PositionModel
from app.api.v1.chenreact_system.role.model import RoleModel
from app.api.v1.chenreact_system.tenant.model import TenantModel
from app.api.v1.chenreact_system.user.model import UserModel, UserRolesModel
...
class InitializeData:
    ...
    async def init_db(self) -> None:
        ...
        - None
        """
        # 先创建表结构，再导入种子数据（全新安装无需 schema patch）

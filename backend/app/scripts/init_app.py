...
async def lifespan(app: FastAPI) -> AsyncGenerator[Any, Any]:
    ...
    """
    from app.api.v1.chenreact_system.dict.service import DictDataService
    from app.api.v1.chenreact_system.params.service import ParamsService
...
def register_routers(app: FastAPI) -> None:
    ...
    from app.api.v1.chenreact_common import common_router
    from app.api.v1.chenreact_monitor import monitor_router
    from app.api.v1.chenreact_system import system_router
    ...
    from app.plugin.chenreact_ai.chat.ws import WS_AI

...
async def get_obj_detail_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:tenant:query"]))],
) -> JSONResponse:
...
async def create_obj_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:tenant:create"]))],
) -> JSONResponse:
...
async def update_obj_controller(
    ...
    id: Annotated[int, Path(description="租户ID")],
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:tenant:update"]))],
) -> JSONResponse:
...
async def delete_obj_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:tenant:delete"]))],
) -> JSONResponse:
...
async def batch_set_available_obj_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:tenant:patch"]))],
) -> JSONResponse:

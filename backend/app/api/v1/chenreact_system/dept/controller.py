...
async def get_dept_tree_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:dept:query"]))],
) -> JSONResponse:
    """
    查询部门树
...
async def get_obj_detail_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:dept:detail"]))],
) -> JSONResponse:
    """
    查询部门详情
...
async def create_obj_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:dept:create"]))],
) -> JSONResponse:
    """
    创建部门
...
async def update_obj_controller(
    ...
    id: Annotated[int, Path(description="部门ID")],
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:dept:update"]))],
) -> JSONResponse:
    """
    修改部门
...
async def delete_obj_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:dept:delete"]))],
) -> JSONResponse:
    """
    删除部门
...
async def batch_set_available_obj_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:dept:patch"]))],
) -> JSONResponse:
    """
    批量修改部门状态

...
from app.api.v1.chenreact_system.menu.schema import MenuOutSchema
from app.api.v1.chenreact_system.role.schema import RoleOutSchema
from app.common.enums import QueueEnum
from app.core.base_schema import BaseSchema, CommonSchema, TenantBySchema, UserBySchema
from app.core.validator import DateTimeStr, email_validator, mobile_validator, password_plain_validator, username_validator
...
class UserRegisterSchema(BaseModel):
    ...
    def validate_password(cls, value: str):
        ...
        异常:
        - ValueError: 长度不在允许范围内。
        """
        return password_plain_validator(value)
...
class ResetPasswordSchema(BaseModel):
    ...
    password: str = Field(..., max_length=128, description="新密码")

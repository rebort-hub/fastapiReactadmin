...
async def get_obj_detail_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:notice:detail"]))],
) -> JSONResponse:
    """
    获取公告详情。
...
async def get_obj_list_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:notice:query"]))],
) -> JSONResponse:
    """
    查询公告。
...
async def create_obj_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:notice:create"]))],
) -> JSONResponse:
    """
    创建公告。
...
async def update_obj_controller(
    ...
    id: Annotated[int, Path(description="公告ID")],
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:notice:update"]))],
) -> JSONResponse:
    """
    修改公告。
...
async def delete_obj_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:notice:delete"]))],
) -> JSONResponse:
    """
    删除公告。
...
async def batch_set_available_obj_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:notice:patch"]))],
) -> JSONResponse:
    """
    批量修改公告状态。
...
async def export_obj_list_controller(
    search: Annotated[NoticeQueryParam, Depends()],
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:notice:export"]))],
) -> StreamingResponse:
    """
    导出公告。

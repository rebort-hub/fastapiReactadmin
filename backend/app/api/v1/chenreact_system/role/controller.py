...
async def get_obj_list_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:role:query"]))],
) -> JSONResponse:
    """
    查询角色
...
async def get_obj_detail_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:role:detail"]))],
) -> JSONResponse:
    """
    查询角色详情
...
async def create_obj_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:role:create"]))],
) -> JSONResponse:
    """
    创建角色
...
async def update_obj_controller(
    ...
    id: Annotated[int, Path(description="角色ID")],
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:role:update"]))],
) -> JSONResponse:
    """
    修改角色
...
async def delete_obj_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:role:delete"]))],
) -> JSONResponse:
    """
    删除角色
...
async def batch_set_available_obj_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:role:patch"]))],
) -> JSONResponse:
    """
    批量修改角色状态
...
async def set_role_permission_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:role:permission"]))],
) -> JSONResponse:
    """
    角色授权
...
async def export_obj_list_controller(
    search: Annotated[RoleQueryParam, Depends()],
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:role:export"]))],
) -> StreamingResponse:
    """
    导出角色

...
async def get_type_detail_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:dict_type:detail"]))],
) -> JSONResponse:
    """
    获取字典类型详情
...
async def get_type_list_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:dict_type:query"]))],
) -> JSONResponse:
    """
    查询字典类型
...
async def create_type_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:dict_type:create"]))],
) -> JSONResponse:
    """
    创建字典类型
...
async def update_type_controller(
    ...
    redis: Annotated[Redis, Depends(redis_getter)],
    id: Annotated[int, Path(description="字典类型ID", ge=1)],
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:dict_type:update"]))],
) -> JSONResponse:
    """
    修改字典类型
...
async def delete_type_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:dict_type:delete"]))],
) -> JSONResponse:
    """
    删除字典类型
...
async def batch_set_available_dict_type_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:dict_type:patch"]))],
) -> JSONResponse:
    """
    批量修改字典类型状态
...
async def export_type_list_controller(
    search: Annotated[DictTypeQueryParam, Depends()],
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:dict_type:export"]))],
) -> StreamingResponse:
    """
    导出字典类型
...
async def get_data_detail_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:dict_data:detail"]))],
) -> JSONResponse:
    """
    获取字典数据详情
...
async def get_data_list_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:dict_data:query"]))],
) -> JSONResponse:
    """
    查询字典数据
...
async def create_data_controller(
    ...
    redis: Annotated[Redis, Depends(redis_getter)],
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:dict_data:create"]))],
) -> JSONResponse:
    """
    创建字典数据
...
async def update_data_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:dict_data:update"]))],
) -> JSONResponse:
    """
    修改字典数据
...
async def delete_data_controller(
    redis: Annotated[Redis, Depends(redis_getter)],
    ids: Annotated[list[int], Body(description="ID列表")],
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:dict_data:delete"]))],
) -> JSONResponse:
    """
    删除字典数据
...
async def batch_set_available_dict_data_controller(
    data: BatchSetAvailable,
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:dict_data:patch"]))],
) -> JSONResponse:
    """
    批量修改字典数据状态
...
async def export_data_list_controller(
    search: Annotated[DictDataQueryParam, Depends()],
    page: Annotated[PaginationQueryParam, Depends()],
    auth: Annotated[AuthSchema, Depends(AuthPermission(["chenreact_system:dict_data:export"]))],
) -> StreamingResponse:
    """
    导出字典数据

...
from app.api.v1.chenreact_monitor.cache.schema import CacheInfoSchema, CacheMonitorSchema
...
@CacheRouter.get(
    "/info",
    dependencies=[Depends(AuthPermission(["chenreact_monitor:cache:query"]))],
    summary="获取缓存监控信息",
...
@CacheRouter.delete(
    ...
    dependencies=[Depends(AuthPermission(["chenreact_monitor:cache:delete"]))],

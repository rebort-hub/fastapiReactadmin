...
@ResourceRouter.get(
    ...
    dependencies=[Depends(AuthPermission(["chenreact_monitor:resource:query"]))],
)
...
@ResourceRouter.post(
    ...
    dependencies=[Depends(AuthPermission(["chenreact_monitor:resource:upload"]))],
)
...
@ResourceRouter.get(
    ...
    summary="下载文件",
    description="下载指定文件",
    dependencies=[Depends(AuthPermission(["chenreact_monitor:resource:download"]))],
)
...
@ResourceRouter.delete(
    ...
    dependencies=[Depends(AuthPermission(["chenreact_monitor:resource:delete"]))],
)
...
@ResourceRouter.post(
    ...
    description="移动文件或目录",
    response_model=ResponseSchema[None],
    dependencies=[Depends(AuthPermission(["chenreact_monitor:resource:move"]))],
)
...
@ResourceRouter.post(
    ...
    description="复制文件或目录",
    response_model=ResponseSchema[None],
    dependencies=[Depends(AuthPermission(["chenreact_monitor:resource:copy"]))],
)
...
@ResourceRouter.post(
    ...
    response_model=ResponseSchema[None],
    dependencies=[Depends(AuthPermission(["chenreact_monitor:resource:rename"]))],
)
...
@ResourceRouter.post(
    ...
    response_model=ResponseSchema[None],
    dependencies=[Depends(AuthPermission(["chenreact_monitor:resource:create_dir"]))],
)
...
@ResourceRouter.post(
    ...
    description="导出资源列表",
    response_model=ResponseSchema[None],
    dependencies=[Depends(AuthPermission(["chenreact_monitor:resource:export"]))],
)

...
from app.common.constant import PaginationConstant
...
class PaginationQueryParam:
    ...
    def __init__(
        ...
        page_size: int = Query(
            default=PaginationConstant.DEFAULT_PAGE_SIZE,
            description="每页数量",
            ge=1,
            le=PaginationConstant.MAX_PAGE_SIZE,
        ),
        ...
        - page_size (int | None): 每页数量，默认 10，最大 PaginationConstant.MAX_PAGE_SIZE。

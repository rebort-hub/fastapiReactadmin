...
export const themeMenuStyleRecord: Record<UnionKey.ThemeMenuStyle, App.I18n.I18nKey> = {
  dark: 'theme.menuStyle.dark',
  layout: 'theme.menuStyle.layout',
  light: 'theme.menuStyle.light'
};

export const LAYOUT_MODE_ORDER: UnionKey.ThemeLayoutMode[] = [
  'horizontal',
  'horizontal-mix',
  'vertical',
  'vertical-mix'

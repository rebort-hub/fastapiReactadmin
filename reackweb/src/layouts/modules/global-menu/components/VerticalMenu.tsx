...
const VerticalMenu = memo(() => {
  ...
  const { siderInverted } = getSiderMenuAppearance(themeSettings.sider, darkMode);
  ...
  return (
    <SimpleScrollbar className="bg-transparent!">
      <AMenu
        className={clsx('size-full transition-300 border-0! bg-transparent!')}
        ...
        theme={siderInverted ? 'dark' : 'light'}

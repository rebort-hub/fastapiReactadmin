...
export const themeSlice = createSlice({
  ...
  reducers: {
    ...
    setMenuStyle(state, { payload }: PayloadAction<UnionKey.ThemeMenuStyle>) {
      state.settings.sider.menuStyle = payload;
      state.settings.sider.inverted = payload === 'dark';
    },
    ...
    setSiderInverted(state, { payload }: PayloadAction<boolean>) {
      ...
      state.settings.sider.menuStyle = payload ? 'dark' : 'light';
    },

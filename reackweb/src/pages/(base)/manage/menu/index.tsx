...
import { TableFormBinder, TableHeaderOperation, useTable, useTableOperate, useTableScroll } from '@/features/table';
...
const Menu = () => {
  ...
  return (
    <div className="h-full min-h-500px flex-col-stretch gap-16px overflow-hidden lt-sm:overflow-auto">
      <TableFormBinder form={searchProps.form} />
      <OperateFormBinder />
      <ACard
        ...
        extra={
          <TableHeaderOperation
            add={onAdd}
            addPermission={Perm.Menu.create}
            columns={columnChecks}
            deletePermission={Perm.Menu.delete}

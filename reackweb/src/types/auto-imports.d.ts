...
declare global {
  ...
  const Auth: typeof import('../components/Auth')['default']
  ...
  const IconAntDesignNotificationOutlined: typeof import('~icons/ant-design/notification-outlined.tsx')['default']
  ...
  const IconIcRoundHelpOutline: typeof import('~icons/ic/round-help-outline.tsx')['default']
  ...
  const IconIcRoundUpload: typeof import('~icons/ic/round-upload.tsx')['default']
  ...
  const IconMdiFileOutline: typeof import('~icons/mdi/file-outline.tsx')['default']
  const IconMdiFolderOutline: typeof import('~icons/mdi/folder-outline.tsx')['default']
  ...
  const LoginBg: typeof import('../components/LoginBg')['default']

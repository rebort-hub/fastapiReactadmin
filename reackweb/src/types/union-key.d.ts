...
declare namespace UnionKey {
  ...
  /**
   * The sider menu style
   *
   * - light: light background sider
   * - dark: dark background sider
   * - layout: sider background follows layout color
   */
  type ThemeMenuStyle = 'dark' | 'layout' | 'light';
